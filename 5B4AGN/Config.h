// Config.h — EEPROM-backed configuration for the 5B4AGN BPF controller.
// Layout & semantics documented in ../docs/CONFIGURATION.md.
#ifndef BPF_CONFIG_H
#define BPF_CONFIG_H
...
struct __attribute__((packed)) Config {
  ...
  uint32_t crc32_value;  // CRC32 over bytes [0 .. sizeof(Config)-4)
};
...
inline void defaults(Config& c, const char* defHostname) {
  ...
  c.radio_port       = 13013;     // Thetis default; Node-Red flows use 7355
